                                    ...
                                    <div className="relative" onClick={(e) => e.stopPropagation()}>
                                        ...
                                        <AnimatePresence>
                                            {dropdownOpenId === course.fbId && (
                                                ...
                                                >
                                                    <button onClick={() => router.push(`/admin/courses/edit?id=${course.fbId}`)} className="text-left px-3 py-2 hover:bg-slate-50 rounded-lg text-sm font-semibold text-emerald-700">Edit</button>
